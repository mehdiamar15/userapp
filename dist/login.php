                        ...
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            ...
                            <div class="card-body">
                                ...
                                if (@$_GET['Empty'] == true) {
                                    ?>
                                    <div id="Blanks"
                                         class="alert-light text-danger text-center py-3"><?php echo $_GET['Empty'] ?></div>
                                    <?php
                                }
                                ?>
                                ...
                                if (@$_GET['Invalid'] == true) {
                                    ?>
                                    <div id="invalid"
                                         class="alert-light text-danger text-center py-3"><?php echo $_GET['Invalid'] ?></div>
                                    <?php
                                }
                                ?>
                                ...
                                <form action="php/process.php" method="POST">
                                    <div class="form-group"><label class="small mb-1"
                                                ...
                                                type="text" name="email" class="form-control" id="example1"
                                                placeholder="enter your email"/></div>
                                    <div class="form-group"><label class="small mb-1"
                                                                   for="inputPassword">Password</label><input
                                                type="password" name="Password" class="form-control" id="example1"
